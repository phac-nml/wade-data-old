...
#' @details
#'
#' VFDB is a download from the web site as a single multifasta. When a new download is made, on the Windows
...
VFDB_pipeline <- function(Org_id, SampleNo, curr_work_dir) {
  ...
  # SampleNo <- "SC20-2946-A"           #"/home/wdemczuk/Documents/Typing/list.csv"
